    ...
    return(
        <div className="container-fluid" id="home-div">
            ...
            <div className="product-slide">
                <div className="carousel-item active" id="electronics">
            ...
            <div className="carousel-item" id="jewelery">
                <div className="container description">
                    {/* <h3>Jewelery</h3> */}
                        {/* <p>
            ...
            <div className="carousel-item" id="mens-clothing">
                <div className="container description">
            ...
            <div className="carousel-item" id="womens-clothing">
                <div className="container description">
...
{token === null ? <button className='btn btn-primary shop-btn' onClick={()=>navigate("/login")}>Shop now </button>
    : 
<button className='btn btn-primary shop-btn' onClick={()=>navigate('/products')}>Shop now </button> }
</div>  
        <div>
